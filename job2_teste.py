...
class Conector_mysql:
    ...
    def envia_mysql(self, dfs, table):
        ...
        self.dfs.write.format("jdbc")\
                ...
                .option("dbtable", self.db + "." + self.table).save()
...
#dfs_arrecadacao = spark.read.parquet(path='gs://soulcode-mineracao/original/arrecadacao.parquet')
dfs_barragens = spark.read.parquet(path='gs://soulcode-mineracao/original/barragens.parquet') 
dfs_autuacao = spark.read.parquet(path='gs://soulcode-mineracao/original/autuacao.parquet')
dfs_beneficiada = spark.read.parquet(path='gs://soulcode-mineracao/original/beneficiada.parquet')
dfs_distribuicao = spark.read.parquet(path='gs://soulcode-mineracao/original/distribuicao.parquet')
